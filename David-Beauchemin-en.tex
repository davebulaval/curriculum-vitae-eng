...
\begin{document}
	...
	\par{\centering{\bf\sffamily\Huge David Beauchemin}\\\vspace{2pt}
		...
		\begin{tabular}{L!{\VRule}R}
			...
			\multirow{1}{*}{\includegraphics[scale=0.1]{images/UL_P.pdf} \tab[0.6cm]}  &  Laval University \\[-6pt]
		\end{tabular}
		...
		\begin{tabular}{L!{\VRule}R}
			2020 -- \tab[.7cm]   &{\bf {Applied AI Researcher in Natural Language Processing}}\\
	...
	\newpage	
		...
		\begin{tabular}{L!{\VRule}R}
			...
			&\\[-6pt]
			2020  & \textbf{Détection de doublons parmi des informations non structurées provenant de sources de données externes}\\
